...
- Web dashboard 可显式绑定项目根，展示 overview/artifacts/gates/audit/roles/workflows/settings、human gate command/gate/request/risk 上下文和 audit hash/filter，并通过 `donkey init` 生成的 `.donkey/web-session.json` token 执行 human approval。
