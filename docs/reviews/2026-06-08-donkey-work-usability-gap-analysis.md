...
当前状态：2026-06-08 后续增量已新增 work usability sample set schema 和 CLI `eval work-usability --samples`。默认阈值为 10 个样本、5 个 ready run、5 个真实 provider run、2 个真实 PR，并要求所有样本有隔离证据；fixture 可降低阈值回归测试，但真实仓库样本本身仍未补齐。
